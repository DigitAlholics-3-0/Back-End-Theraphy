...
import com.theraphy.backendtheraphy.profiles.resource.CreateMedicalHistoryResource;
import com.theraphy.backendtheraphy.profiles.resource.MedicalHistoryResource;
import com.theraphy.backendtheraphy.profiles.resource.UpdateMedicalHistoryResource;
...
public class MedicalHistoryMapper implements Serializable {
    ...
    public MedicalHistory toModel(UpdateMedicalHistoryResource resource) {return mapper.map(resource, MedicalHistory.class);}
